...
export default function PWCouponCodePage() {
  return (
      ...
      <header className="bg-zinc-900 text-white py-4">
        <div className="container mx-auto px-4">
          ...
          <nav className="flex flex-wrap justify-center">
            ...
            <Link href="/pw-coupon-code" className="px-4 py-2 bg-zinc-800 m-1">
              PW COUPON CODE
            </Link>
        ...
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          <div className="lg:w-2/3">
            <div className="bg-white p-6 mb-8 shadow-sm rounded-sm">
              <h1 className="text-3xl font-bold text-zinc-700 mb-4">PW COUPON CODE</h1>
              <p className="mb-6">
                Find the latest and exclusive coupon codes for all Physics Wallah courses. Use these coupons to get
                discounts on your favorite PW courses across all categories.
              </p>
            </div>
            ...
            <FeaturedCoupon
              code="ADIYAD0002"
              title="EXCLUSIVE: Special Discount for All PW Courses"
